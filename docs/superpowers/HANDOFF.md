...
- [ ] C1. 신규 온보딩: 첫 탭 유도 오버레이 + 첫 성취 (UX/기획 P0)
- [ ] C2. 오프라인 보상 모달 (UIScene 제거 회귀 복구; 기획 P1)
- [ ] C3. 마일스톤 연출: Lv5/10/25 배너+플래시 (기획 P1)
- [ ] C4. HUD 자원 아이콘(투표함/말풍선/하트) — codex 아트 (디자인 P0-4)
- [ ] C5. 표/초·업글 델타 표기, 사건 알림 뱃지 (기획 P2)
- [ ] C6. 벽 장식(시계/포스터)로 빈 벽 채우기 — codex 아트 (디자인 P1-1)
- [ ] C7. 월드 탭-수집 프롭(투표함) (기획 P1-4)
- [ ] C8. QA 잔여: BUG-05 탭강제전환, BUG-11 프레스티지 표시, BUG-01 퀘스트 자동완료
