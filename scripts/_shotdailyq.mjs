...
const seed={version:3,votes:5e5,explain:8000,trust:78,days:18,paused:false,selected:"desk",activeTab:"goals",
  ...
  endless:5,daily:{day:99999999,streak:1,qday:Math.floor(new Date(now).setHours(0,0,0,0)/86400000),clicks:100,events:1,upgrades:5,claimed:{"d-clicks":true}},eventReadyAt:now+9e8,offline2xDay:99999999,log:["x"]};
...
await p.screenshot({path:"/tmp/rv-dailyq.png"});
