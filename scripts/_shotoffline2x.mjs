...
const seed={version:3,votes:1e6,explain:8000,trust:78,days:18,paused:false,selected:"desk",activeTab:"facilities",
  ...
  achievements:{v100:true,v1000:true,v100k:true},quests:{"first-500":true,"desk-5":true,"trust-80":true,"cps-25":true,"stage-2":true,"facility-total-30":true},endless:5,daily:{day:99999999,streak:1},eventReadyAt:now+9e8,offline2xDay:0,log:["x"]};
...
await p.screenshot({path:"/tmp/rv-offline2x.png"});
