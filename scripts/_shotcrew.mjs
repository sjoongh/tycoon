...
const seed={version:3,votes:1e8,explain:1e5,trust:78,days:18,paused:false,selected:"desk",activeTab:"crew",
  ...
  staff:{clerk:3,auditor:2,runner:1,engineer:1,analyst:1,speaker:1},
  ...
  achievements:{v100:true,v1000:true},quests:{"first-500":true,"desk-5":true,"trust-80":true,"cps-25":true,"stage-2":true,"facility-total-30":true},endless:3,daily:{day:99999999,streak:1},eventReadyAt:0,log:["x"]};
...
// scroll crew list to show new staff
await p.evaluate(()=>{const l=document.querySelector(".gp-stafflist");if(l)l.scrollTop=120;});
await p.waitForTimeout(300);
await p.screenshot({path:"/tmp/gp-crew-clean.png"});
