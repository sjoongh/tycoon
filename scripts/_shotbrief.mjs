...
const seed={version:3,votes:5e5,explain:50000,trust:35,days:18,paused:false,selected:"desk",activeTab:"facilities",
  ...
  quests:{"first-500":true,"desk-5":true,"trust-80":true,"cps-25":true,"stage-2":true,"facility-total-30":true},endless:5,daily:{day:99999999,streak:1},eventReadyAt:now+9e8,briefReadyAt:0,briefEndsAt:0,offline2xDay:99999999,log:["x"]};
...
await p.screenshot({path:"/tmp/rv-brief.png"});
