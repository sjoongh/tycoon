...
const seed={version:3,votes:5e5,explain:8000,trust:78,days:18,paused:false,selected:"desk",activeTab:"crew",
  ...
  stage:{area:5,progress:500,target:99999,completed:4},prestige:{seals:3,runs:1,bestArea:5,totalSeals:5,upgrades:{}},
...
await p.evaluate(()=>{const l=document.querySelector(".gp-stafflist");if(l)l.scrollTop=0;});
await p.waitForTimeout(200);
await p.screenshot({path:"/tmp/rv-synergy.png"});
