...
const seed={version:3,votes:1e8,explain:5e4,trust:80,days:5,paused:false,selected:"desk",activeTab:"prestige",
  ...
  prestige:{seals:40,runs:2,bestArea:8,totalSeals:60,upgrades:{procedure:5,manual:3,audit:4,vault:6,staffing:2,reputation:3}},
...
await p.screenshot({path:"/tmp/gp-prestige8.png"});
